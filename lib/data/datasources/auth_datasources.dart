...
import 'package:safetycheck/data/models/requests/password_model.dart';
import 'package:safetycheck/data/models/response/edit_profil_response_model.dart';
import 'package:safetycheck/data/models/response/forgotpassword_response_model.dart';
import 'package:safetycheck/data/models/response/login_response.dart';
import 'package:safetycheck/data/models/response/profil_response_model.dart';
...
class AuthDatasource {
  final baseUrl = 'http://192.168.76.85:5000';
